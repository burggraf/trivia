export default {
  ...
  contacts: {
    ...
    noGroupSelected: "No groupanization selected",
  ...
  privacy: {
    ...
    sections: {
      ...
      dataProtection: {
        ...
        content:
          "We implement appropriate technical and groupal measures to protect the security of your personal information.",
      },
      cookies: {
  ...
  group: {
    noCurrentGroup: "No group selected",
    ...
    listTitle: "Groups",
    addNewTitle: "Add New Group",
    titleLabel: "Group Title",
    titlePlaceholder: "Enter group title",
    addButton: "Add New Group",
    currentOrg: "Current Group",
  },
  groups: {
    title: "Title",
  },
  groupDetail: {
    titleMissing: "Group title is required",
  ...
  notifications: {
    ...
    join: "Join",
    reject: "Reject",
    defaultGroupTitle: "an group",
    confirmReject: "Are you sure you want to reject this invitation?",
    noNotifications: "No notifications",
  },
  invitationsModal: {
    title: "Group Invitations",
    description: "Review and manage your pending group invitations",
